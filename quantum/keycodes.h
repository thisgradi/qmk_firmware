...
// Keycodes
    ...
    QK_MIDI_NOTE_C_N1 = 0x7100,
    QK_MIDI_NOTE_C_SHARP_N1 = 0x7101,
    QK_MIDI_NOTE_D_N1 = 0x7102,
    QK_MIDI_NOTE_D_SHARP_N1 = 0x7103,
    QK_MIDI_NOTE_E_N1 = 0x7104,
    QK_MIDI_NOTE_F_N1 = 0x7105,
    QK_MIDI_NOTE_F_SHARP_N1 = 0x7106,
    QK_MIDI_NOTE_G_N1 = 0x7107,
    QK_MIDI_NOTE_G_SHARP_N1 = 0x7108,
    QK_MIDI_NOTE_A_N1 = 0x7109,
    QK_MIDI_NOTE_A_SHARP_N1 = 0x710A,
    QK_MIDI_NOTE_B_N1 = 0x710B,
    QK_MIDI_NOTE_C_0 = 0x710C,
    QK_MIDI_NOTE_C_SHARP_0 = 0x710D,
    QK_MIDI_NOTE_D_0 = 0x710E,
    QK_MIDI_NOTE_D_SHARP_0 = 0x710F,
    QK_MIDI_NOTE_E_0 = 0x7110,
    QK_MIDI_NOTE_F_0 = 0x7111,
    QK_MIDI_NOTE_F_SHARP_0 = 0x7112,
    QK_MIDI_NOTE_G_0 = 0x7113,
    QK_MIDI_NOTE_G_SHARP_0 = 0x7114,
    QK_MIDI_NOTE_A_0 = 0x7115,
    QK_MIDI_NOTE_A_SHARP_0 = 0x7116,
    QK_MIDI_NOTE_B_0 = 0x7117,
    QK_MIDI_NOTE_C_1 = 0x7118,
    QK_MIDI_NOTE_C_SHARP_1 = 0x7119,
    QK_MIDI_NOTE_D_1 = 0x711A,
    QK_MIDI_NOTE_D_SHARP_1 = 0x711B,
    QK_MIDI_NOTE_E_1 = 0x711C,
    QK_MIDI_NOTE_F_1 = 0x711D,
    QK_MIDI_NOTE_F_SHARP_1 = 0x711E,
    QK_MIDI_NOTE_G_1 = 0x711F,
    QK_MIDI_NOTE_G_SHARP_1 = 0x7120,
    QK_MIDI_NOTE_A_1 = 0x7121,
    QK_MIDI_NOTE_A_SHARP_1 = 0x7122,
    QK_MIDI_NOTE_B_1 = 0x7123,
    QK_MIDI_NOTE_C_2 = 0x7124,
    QK_MIDI_NOTE_C_SHARP_2 = 0x7125,
    QK_MIDI_NOTE_D_2 = 0x7126,
    QK_MIDI_NOTE_D_SHARP_2 = 0x7127,
    QK_MIDI_NOTE_E_2 = 0x7128,
    QK_MIDI_NOTE_F_2 = 0x7129,
    QK_MIDI_NOTE_F_SHARP_2 = 0x712A,
    QK_MIDI_NOTE_G_2 = 0x712B,
    QK_MIDI_NOTE_G_SHARP_2 = 0x712C,
    QK_MIDI_NOTE_A_2 = 0x712D,
    QK_MIDI_NOTE_A_SHARP_2 = 0x712E,
    QK_MIDI_NOTE_B_2 = 0x712F,
    QK_MIDI_NOTE_C_3 = 0x7130,
    QK_MIDI_NOTE_C_SHARP_3 = 0x7131,
    QK_MIDI_NOTE_D_3 = 0x7132,
    QK_MIDI_NOTE_D_SHARP_3 = 0x7133,
    QK_MIDI_NOTE_E_3 = 0x7134,
    QK_MIDI_NOTE_F_3 = 0x7135,
    QK_MIDI_NOTE_F_SHARP_3 = 0x7136,
    QK_MIDI_NOTE_G_3 = 0x7137,
    QK_MIDI_NOTE_G_SHARP_3 = 0x7138,
    QK_MIDI_NOTE_A_3 = 0x7139,
    QK_MIDI_NOTE_A_SHARP_3 = 0x713A,
    QK_MIDI_NOTE_B_3 = 0x713B,
    QK_MIDI_NOTE_C_4 = 0x713C,
    QK_MIDI_NOTE_C_SHARP_4 = 0x713D,
    QK_MIDI_NOTE_D_4 = 0x713E,
    QK_MIDI_NOTE_D_SHARP_4 = 0x713F,
    QK_MIDI_NOTE_E_4 = 0x7140,
    QK_MIDI_NOTE_F_4 = 0x7141,
    QK_MIDI_NOTE_F_SHARP_4 = 0x7142,
    QK_MIDI_NOTE_G_4 = 0x7143,
    QK_MIDI_NOTE_G_SHARP_4 = 0x7144,
    QK_MIDI_NOTE_A_4 = 0x7145,
    QK_MIDI_NOTE_A_SHARP_4 = 0x7146,
    QK_MIDI_NOTE_B_4 = 0x7147,
    QK_MIDI_NOTE_C_5 = 0x7148,
    QK_MIDI_NOTE_C_SHARP_5 = 0x7149,
    QK_MIDI_NOTE_D_5 = 0x714A,
    QK_MIDI_NOTE_D_SHARP_5 = 0x714B,
    QK_MIDI_NOTE_E_5 = 0x714C,
    QK_MIDI_NOTE_F_5 = 0x714D,
    QK_MIDI_NOTE_F_SHARP_5 = 0x714E,
    QK_MIDI_NOTE_G_5 = 0x714F,
    QK_MIDI_NOTE_G_SHARP_5 = 0x7150,
    QK_MIDI_NOTE_A_5 = 0x7151,
    QK_MIDI_NOTE_A_SHARP_5 = 0x7152,
    QK_MIDI_NOTE_B_5 = 0x7153,
    QK_MIDI_NOTE_C_6 = 0x7154,
    QK_MIDI_NOTE_C_SHARP_6 = 0x7155,
    QK_MIDI_NOTE_D_6 = 0x7156,
    QK_MIDI_NOTE_D_SHARP_6 = 0x7157,
    QK_MIDI_NOTE_E_6 = 0x7158,
    QK_MIDI_NOTE_F_6 = 0x7159,
    QK_MIDI_NOTE_F_SHARP_6 = 0x715A,
    QK_MIDI_NOTE_G_6 = 0x715B,
    QK_MIDI_NOTE_G_SHARP_6 = 0x715C,
    QK_MIDI_NOTE_A_6 = 0x715D,
    QK_MIDI_NOTE_A_SHARP_6 = 0x715E,
    QK_MIDI_NOTE_B_6 = 0x715F,
    QK_MIDI_NOTE_C_7 = 0x7160,
    QK_MIDI_NOTE_C_SHARP_7 = 0x7161,
    QK_MIDI_NOTE_D_7 = 0x7162,
    QK_MIDI_NOTE_D_SHARP_7 = 0x7163,
    QK_MIDI_NOTE_E_7 = 0x7164,
    QK_MIDI_NOTE_F_7 = 0x7165,
    QK_MIDI_NOTE_F_SHARP_7 = 0x7166,
    QK_MIDI_NOTE_G_7 = 0x7167,
    QK_MIDI_NOTE_G_SHARP_7 = 0x7168,
    QK_MIDI_NOTE_A_7 = 0x7169,
    QK_MIDI_NOTE_A_SHARP_7 = 0x716A,
    QK_MIDI_NOTE_B_7 = 0x716B,
    QK_MIDI_OCTAVE_N2 = 0x716C,
    QK_MIDI_OCTAVE_N1 = 0x716D,
    QK_MIDI_OCTAVE_0 = 0x716E,
    QK_MIDI_OCTAVE_1 = 0x716F,
    QK_MIDI_OCTAVE_2 = 0x7170,
    QK_MIDI_OCTAVE_3 = 0x7171,
    QK_MIDI_OCTAVE_4 = 0x7172,
    QK_MIDI_OCTAVE_5 = 0x7173,
    QK_MIDI_OCTAVE_6 = 0x7174,
    QK_MIDI_OCTAVE_7 = 0x7175,
    QK_MIDI_OCTAVE_DOWN = 0x718D,
    QK_MIDI_OCTAVE_UP = 0x718E,
    QK_MIDI_TRANSPOSE_N6 = 0x718F,
    QK_MIDI_TRANSPOSE_N5 = 0x7190,
    QK_MIDI_TRANSPOSE_N4 = 0x7191,
    QK_MIDI_TRANSPOSE_N3 = 0x7192,
    QK_MIDI_TRANSPOSE_N2 = 0x7193,
    QK_MIDI_TRANSPOSE_N1 = 0x7194,
    QK_MIDI_TRANSPOSE_0 = 0x7195,
    QK_MIDI_TRANSPOSE_1 = 0x7196,
    QK_MIDI_TRANSPOSE_2 = 0x7197,
    QK_MIDI_TRANSPOSE_3 = 0x7198,
    QK_MIDI_TRANSPOSE_4 = 0x7199,
    QK_MIDI_TRANSPOSE_5 = 0x719A,
    QK_MIDI_TRANSPOSE_6 = 0x719B,
    QK_MIDI_TRANSPOSE_DOWN = 0x719C,
    QK_MIDI_TRANSPOSE_UP = 0x719D,
    QK_MIDI_VELOCITY_0 = 0x719E,
    QK_MIDI_VELOCITY_1 = 0x719F,
    QK_MIDI_VELOCITY_2 = 0x71A0,
    QK_MIDI_VELOCITY_3 = 0x71A1,
    QK_MIDI_VELOCITY_4 = 0x71A2,
    QK_MIDI_VELOCITY_5 = 0x71A3,
    QK_MIDI_VELOCITY_6 = 0x71A4,
    QK_MIDI_VELOCITY_7 = 0x71A5,
    QK_MIDI_VELOCITY_8 = 0x71A6,
    QK_MIDI_VELOCITY_9 = 0x71A7,
    QK_MIDI_VELOCITY_10 = 0x71A8,
    QK_MIDI_VELOCITY_DOWN = 0x71A9,
    QK_MIDI_VELOCITY_UP = 0x71AA,
    QK_MIDI_CHANNEL_1 = 0x71AB,
    QK_MIDI_CHANNEL_2 = 0x71AC,
    QK_MIDI_CHANNEL_3 = 0x71AD,
    QK_MIDI_CHANNEL_4 = 0x71AE,
    QK_MIDI_CHANNEL_5 = 0x71AF,
    QK_MIDI_CHANNEL_6 = 0x71B0,
    QK_MIDI_CHANNEL_7 = 0x71B1,
    QK_MIDI_CHANNEL_8 = 0x71B2,
    QK_MIDI_CHANNEL_9 = 0x71B3,
    QK_MIDI_CHANNEL_10 = 0x71B4,
    QK_MIDI_CHANNEL_11 = 0x71B5,
    QK_MIDI_CHANNEL_12 = 0x71B6,
    QK_MIDI_CHANNEL_13 = 0x71B7,
    QK_MIDI_CHANNEL_14 = 0x71B8,
    QK_MIDI_CHANNEL_15 = 0x71B9,
    QK_MIDI_CHANNEL_16 = 0x71BA,
    QK_MIDI_CHANNEL_DOWN = 0x71BB,
    QK_MIDI_CHANNEL_UP = 0x71BC,
    QK_MIDI_ALL_NOTES_OFF = 0x71BD,
    QK_MIDI_SUSTAIN = 0x71BE,
    QK_MIDI_PORTAMENTO = 0x71BF,
    QK_MIDI_SOSTENUTO = 0x71C0,
    QK_MIDI_SOFT = 0x71C1,
    QK_MIDI_LEGATO = 0x71C2,
    QK_MIDI_MODULATION = 0x71C3,
    QK_MIDI_MODULATION_SPEED_DOWN = 0x71C4,
    QK_MIDI_MODULATION_SPEED_UP = 0x71C5,
    QK_MIDI_PITCH_BEND_DOWN = 0x71C6,
    QK_MIDI_PITCH_BEND_UP = 0x71C7,
    QK_MIDI_ON = 0x71C8,
    QK_MIDI_OFF = 0x71C9,
    QK_MIDI_TOGGLE = 0x71CA,
...
#define IS_MIDI_KEYCODE(code) ((code) >= QK_MIDI_NOTE_C_N1 && (code) <= QK_MIDI_TOGGLE)
...
#define MIDI_KEYCODE_RANGE                  QK_MIDI_NOTE_C_N1 ... QK_MIDI_TOGGLE
